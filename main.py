...
def build_widgets():
    ...
    wdg['x'] = bmw.Select(title='X-Axis (required)', value='None', options=['None'] + columns, id='x_drop_x-'+str(uniq), css_classes=['wdgkey-x'])
    wdg['x_group'] = bmw.Select(title='Group X-Axis By', value='None', options=['None'] + seriesable, id='x_drop_xgroup-'+str(uniq), css_classes=['wdgkey-x_group'])
    wdg['y_dropdown'] = bmw.Div(text='Y-Axis (required)', id='y_dropdown-'+str(uniq))
    wdg['y'] = bmw.Select(title='Y-Axis (required)', value='None', options=['None'] + columns, id='y_drop_y-'+str(uniq), css_classes=['wdgkey-y'])
    wdg['y_agg'] = bmw.Select(title='Y-Axis Aggregation', value='None', options=AGGREGATIONS, id='y_drop_y_agg-'+str(uniq), css_classes=['wdgkey-y_agg'])
    ...
    wdg['series'] = bmw.Select(title='Separate Series By', value='None', options=['None'] + seriesable, id='series_drop_series-'+str(uniq), css_classes=['wdgkey-series'])
    wdg['series_stack'] = bmw.Select(title='Series Stacking', value='Unstacked', options=['Unstacked', 'Stacked'], id='series_drop_stack-'+str(uniq), css_classes=['wdgkey-series_stack'])
    wdg['explode_dropdown'] = bmw.Div(text='Explode', id='explode_dropdown-'+str(uniq))
    wdg['explode'] = bmw.Select(title='Explode By', value='None', options=['None'] + seriesable, id='explode_drop_explode-'+str(uniq), css_classes=['wdgkey-explode'])
    wdg['explode_group'] = bmw.Select(title='Group Exploded Charts By', value='None', options=['None'] + seriesable, id='explode_drop_group-'+str(uniq), css_classes=['wdgkey-explode_group'])
    ...
    for j, col in enumerate(filterable):
        ...
        wdg['filter_'+str(j)] = bmw.CheckboxGroup(labels=val_list, active=list(range(len(val_list))), id='filter_'+str(j)+'-'+str(uniq), css_classes=['wdgkey-filter_'+str(j)])
    ...
    wdg['chart_type'] = bmw.Select(title='Chart Type', value=CHARTTYPES[0], options=CHARTTYPES, id='adjust_plot_chart_type-'+str(uniq), css_classes=['wdgkey-chart_type'])
    wdg['plot_width'] = bmw.TextInput(title='Plot Width (px)', value=str(PLOT_WIDTH), id='adjust_plot_width-'+str(uniq), css_classes=['wdgkey-plot_width'])
    wdg['plot_height'] = bmw.TextInput(title='Plot Height (px)', value=str(PLOT_HEIGHT), id='adjust_plot_height-'+str(uniq), css_classes=['wdgkey-plot_height'])
    wdg['plot_title'] = bmw.TextInput(title='Plot Title', value='', id='adjust_plot_title-'+str(uniq), css_classes=['wdgkey-plot_title'])
    wdg['plot_title_size'] = bmw.TextInput(title='Plot Title Font Size', value=str(PLOT_FONT_SIZE), id='adjust_plot_title_size-'+str(uniq), css_classes=['wdgkey-plot_title_size'])
    wdg['opacity'] = bmw.TextInput(title='Opacity (0-1)', value=str(OPACITY), id='adjust_plot_opacity-'+str(uniq), css_classes=['wdgkey-opacity'])
    wdg['x_scale'] = bmw.TextInput(title='X Scale', value=str(X_SCALE), id='adjust_plot_x_scale-'+str(uniq), css_classes=['wdgkey-x_scale'])
    wdg['x_min'] = bmw.TextInput(title='X Min', value='', id='adjust_plot_x_min-'+str(uniq), css_classes=['wdgkey-x_min'])
    wdg['x_max'] = bmw.TextInput(title='X Max', value='', id='adjust_plot_x_max-'+str(uniq), css_classes=['wdgkey-x_max'])
    wdg['x_title'] = bmw.TextInput(title='X Title', value='', id='adjust_plot_x_title-'+str(uniq), css_classes=['wdgkey-x_title'])
    wdg['x_title_size'] = bmw.TextInput(title='X Title Font Size', value=str(PLOT_FONT_SIZE), id='adjust_plot_x_title_size-'+str(uniq), css_classes=['wdgkey-x_title_size'])
    wdg['x_major_label_size'] = bmw.TextInput(title='X Labels Font Size', value=str(PLOT_AXIS_LABEL_SIZE), id='adjust_plot_x_labels_size-'+str(uniq), css_classes=['wdgkey-x_major_label_size'])
    wdg['x_major_label_orientation'] = bmw.TextInput(title='X Labels Degrees', value=str(PLOT_LABEL_ORIENTATION), id='adjust_plot_x_labels_orientation-'+str(uniq), css_classes=['wdgkey-x_major_label_orientation'])
    wdg['y_scale'] = bmw.TextInput(title='Y Scale', value=str(Y_SCALE), id='adjust_plot_y_scale-'+str(uniq), css_classes=['wdgkey-y_scale'])
    wdg['y_min'] = bmw.TextInput(title='Y  Min', value='', id='adjust_plot_y_min-'+str(uniq), css_classes=['wdgkey-y_min'])
    wdg['y_max'] = bmw.TextInput(title='Y Max', value='', id='adjust_plot_y_max-'+str(uniq), css_classes=['wdgkey-y_max'])
    wdg['y_title'] = bmw.TextInput(title='Y Title', value='', id='adjust_plot_y_title-'+str(uniq), css_classes=['wdgkey-y_title'])
    wdg['y_title_size'] = bmw.TextInput(title='Y Title Font Size', value=str(PLOT_FONT_SIZE), id='adjust_plot_y_title_size-'+str(uniq), css_classes=['wdgkey-y_title_size'])
    wdg['y_major_label_size'] = bmw.TextInput(title='Y Labels Font Size', value=str(PLOT_AXIS_LABEL_SIZE), id='adjust_plot_y_labels_size-'+str(uniq), css_classes=['wdgkey-y_major_label_size'])
    wdg['circle_size'] = bmw.TextInput(title='Circle Size (Dot Only)', value=str(CIRCLE_SIZE), id='adjust_plot_circle_size-'+str(uniq), css_classes=['wdgkey-circle_size'])
    wdg['bar_width'] = bmw.TextInput(title='Bar Width (Bar Only)', value=str(BAR_WIDTH), id='adjust_plot_bar_width-'+str(uniq), css_classes=['wdgkey-bar_width'])
    wdg['line_width'] = bmw.TextInput(title='Line Width (Line Only)', value=str(LINE_WIDTH), id='adjust_plot_line_width-'+str(uniq), css_classes=['wdgkey-line_width'])
